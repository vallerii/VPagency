    ...
    <section className="w-full px-6 py-24 sm:px-10 lg:px-16 lg:py-32">
      <div className="mx-auto w-full max-w-[1440px] grid grid-cols-1 gap-12 sm:grid-cols-2 lg:gap-24">
        <motion.h2
          ...
          className="text-balance text-[10vw] font-medium leading-[1.1] tracking-tighter text-ink sm:text-[6vw] lg:text-[4vw] xl:text-[76px] lg:sticky lg:top-[50%] lg:self-start lg:pt-8"
        >
          {title}
        </motion.h2>
